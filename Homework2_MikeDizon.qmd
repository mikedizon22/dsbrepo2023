...
ggplot() +
  geom_histogram(data = black_shooters, aes(x = fatalities), fill = "blue", alpha = 0.5, bins = 30) +
  geom_histogram(data = white_shooters, aes(x=fatalities), fill = "red", alpha = 0.5, bins = 30) +
...
ggplot() +
  geom_histogram(data = latino_shooters, aes(x = fatalities), fill = "blue", alpha = 0.5, bins = 30) +
  geom_histogram(data = white_shooters, aes(x=fatalities), fill = "red", alpha = 0.5, bins = 30) +
  labs(title = "Distribution of Mass Shooting Fatalities by Shooter's Race", x = "Fatalities", y = "Count", fill = "Shooter's Race") +
  scale_fill_manual(values = c("blue", "red"), labels = c("Latino Shooter", "White Shooter"))
  theme_minimal()
```
...
ggplot(combined_data, aes(x = prior_mental_illness, fill = prior_mental_illness)) +
  geom_bar() +
  labs(x = "Prior Mental Illness", y = "Number of Shootings") +
...
# Scatter Plot: Mental Illness vs. Total Victims
...
# Stacked Bar Chart: Mental Illness vs. Location Type
ggplot(mass_shootings %>% filter(!is.na(prior_mental_illness)), aes(x = prior_mental_illness, fill = location_type)) +
  geom_bar() +
  labs(x = "Prior Mental Illness", y = "Count") +
  ggtitle("Comparison of Location Types based on Mental Illness") +
  theme(legend.position = "bottom")

# Grouped Bar Chart: Mental Illness, Location Type, and Total Victims
ggplot(mass_shootings %>% filter(!is.na(prior_mental_illness)), aes(x = prior_mental_illness, y = total_victims, fill = location_type)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "Prior Mental Illness", y = "Total Victims") +
  ggtitle("Comparison of Mental Illness, Location Type, and Total Victims") +
  theme(legend.position = "bottom")

# Heatmap: Mental Illness, Location Type, and Total Victims
ggplot(mass_shootings %>% filter(!is.na(prior_mental_illness)), aes(x = prior_mental_illness, y = location_type, fill = total_victims)) +
  geom_tile() +
  labs(x = "Prior Mental Illness", y = "Location Type", fill = "Total Victims") +
  ggtitle("Intersection of Mental Illness, Location Type, and Total Victims")
...
# Merge the CO2 per capita and GDP per capita data
co2_gdp <- merge(co2_percap, gdp_percap, by = "year", all = TRUE)

ggplot(energy, aes(x = energy_per_capita, y = GDPpercap)) +
  geom_point() +
  labs(x = "Electricity Usage per Capita per Day (kWh)",
       y = "GDP per Capita",
       title = "Relationship between Electricity Usage and GDP per Capita") +
  theme_minimal()
